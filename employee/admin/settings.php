...
$sessions_query = "SELECT id, ip_address, user_agent, last_activity AS last_active, created_at, session_id FROM user_sessions WHERE user_id = ? ORDER BY last_activity DESC";
