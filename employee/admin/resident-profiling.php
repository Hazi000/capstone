	...
	<script>
		...
		async function loadModels() {
			...
			try {
				...
				const errMsg = 'Failed to load face recognition models. If you are offline, download the model files and place them in the folder: ./admin/models/ (relative to the PHP file).';
				alert(errMsg);
			}
		}
